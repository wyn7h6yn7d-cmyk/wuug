...
/**
 * Next.js Link with spring hover/tap — use for Sign in / Register in the shell and marketing.
 */
export function PressableLink({
  ...
  return (
    <Link href={href} className={cn(fullWidth && "w-full", "inline-flex", className)}>
      <motion.span
        className={cn(
        ...
        whileHover={btnHoverLift(variant === "ghost" ? "ghost" : variant === "primary" ? "primary" : "secondary")}
        whileTap={BTN_TAP}
